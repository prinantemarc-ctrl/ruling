...
const markets: SeedMarket[] = [
  ...
  {
    question: "Will US CPI YoY print below 2.5% in any month of H1 2026?",
    description: "Uses BLS CPI-U year-over-year headline print.",
    closesAt: new Date("2026-07-15T00:00:00Z"),
    bias: "MIXED",
    targetYes: 0.44,
  },
  {
  ...
  },
  {
    ...
    closesAt: new Date("2026-07-19T22:00:00Z"),
    bias: "MIXED",
    targetYes: 0.14,
  },
  {
    question: "Will the LA Lakers win the 2026 NBA Finals?",
    description: "YES if the Lakers are 2026 NBA champions.",
